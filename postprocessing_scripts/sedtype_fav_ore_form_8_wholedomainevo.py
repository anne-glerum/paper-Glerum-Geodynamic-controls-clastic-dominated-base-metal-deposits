...
for m in model_names: 
  ...
  for t in range(0,len(ASPECT_time_steps)):
    ...
    # load state
    LoadState('/scratch/usr/bbpanneg/postprocessing/CERI/9_no1350isotherm_velvec_nosource_nohost.pvsm', LoadStateDataFileOptions='Choose File Names',
    ...
    renderView1.CameraPosition = [position, 284715., 550000]
    renderView1.CameraFocalPoint = [position, 284715., -43924.18361557276]
    ...
    renderView1.CameraParallelScale = 140000
    renderView1.CameraParallelScale = 25000
    
    renderView1.ViewSize = [4000, 500] 
    LoadPalette(paletteName='WhiteBackground')

    # save screenshot
    output_filename=file_name_base+m+'/'+m+'_'+ASPECT_time_steps[t]+'_heatfluxcontours_sedtypes_Tcontours_source_host_sedage2_8_zoom2_evo.png'
    SaveScreenshot(output_filename, renderView1, ImageResolution=[4000, 500],
    ...
    # whole model domain
    renderView1.CameraParallelScale = 300000 #200000
    renderView1.CameraPosition = [350000, 150000, 550000]
    renderView1.CameraFocalPoint = [350000, 150000, -43924.18361557276]

    # save screenshot
    output_filename=file_name_base+m+'/'+m+'_'+ASPECT_time_steps[t]+'_heatfluxcontours_sedtypes_Tcontours_source_host_sedage2_8_wholedomain_evo.png'
