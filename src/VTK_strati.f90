...
subroutine VTK_filled_strati (basement, nreflector, reflector, nfield, fields, names, nx, ny, dx, dy, istep, vex, distb,&
  ...
  integer :: nx, ny, nreflector, nfield, istep, kk, iistep
...
name='Strati-'
  ...
  open(unit=iunit,file=ffoldername//'VTK_strat/'//trim(name)//cstep//'.vtk')
...
end subroutine VTK_filled_strati
